...
export const products: Product[] = [
  ...
  },
  {
    ...
    category: 'Cameras',
    variants: [
      { id: 'white', label: 'White', swatch: '#FFFFFF', swatchImage: '/products/wyze-cam-floodlight-v2-white.png' },
      { id: 'black', label: 'Black', swatch: '#000000', swatchImage: '/products/wyze-cam-floodlight-v2-black.png' },
    ],
  },
  {
  ...
  },
  {
    ...
    category: 'Cameras',
    variants: [
      { id: 'white', label: 'White', swatch: '#FFFFFF', swatchImage: '/products/wyze-battery-cam-pro-white.png' },
      { id: 'black', label: 'Black', swatch: '#000000', swatchImage: '/products/wyze-battery-cam-pro-black.png' },
    ],
  },
