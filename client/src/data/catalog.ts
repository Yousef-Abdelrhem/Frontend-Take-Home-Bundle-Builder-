export interface Variant {
  id: string;
  label: string;
  swatch?: string; // hex color or image path
}
...
export const products: Product[] = [
  // Cameras
  {
    ...
    stepId: 'cameras',
    title: 'Wyze Cam v4',
    description: 'The cheapest Wyze Cam ever made. Night vision, motion detection & alerts.',
    learnMoreUrl: '#',
    compareAtPrice: 33.08,
    price: 27.99,
    image: 'https://via.placeholder.com/200x200?text=Wyze+Cam+v4',
    category: 'Cameras',
    seededQty: 1,
    variants: [
